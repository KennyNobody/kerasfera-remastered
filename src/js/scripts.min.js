...
$(document).ready(function () {
    function e() {
        $(document).width() < 1e3 ? $(".filter__wrapper").customScroll({vertical: !0, horizontal: !1}) : $(".filter__block ul").customScroll({vertical: !0, horizontal: !1})
    }

    $(".popup").magnificPopup(), $(".popup-item").magnificPopup({showCloseBtn: !1}), $(".popup-image").magnificPopup({type: "image", closeOnContentClick: "true"}), $(".branch__slider-wrapper--1").magnificPopup({type: "image", delegate: "a", gallery: {enabled: !0, navigateByImgClick: !0, tCounter: '<span class="mfp-counter">%curr% Ð¸Ð· %total%</span>', preload: [0, 1]}, closeOnContentClick: "true"}), $(".branch__slider-wrapper--2").magnificPopup({type: "image", delegate: "a", gallery: {enabled: !0, navigateByImgClick: !0, tCounter: '<span class="mfp-counter">%curr% Ð¸Ð· %total%</span>', preload: [0, 1]}, closeOnContentClick: "true"}), $(".branch__slider-wrapper--3").magnificPopup({type: "image", delegate: "a", gallery: {enabled: !0, navigateByImgClick: !0, tCounter: '<span class="mfp-counter">%curr% Ð¸Ð· %total%</span>', preload: [0, 1]}, closeOnContentClick: "true"}), $(".swiper-button-next").click(function (e) {
        e.stopPropagation()
        ...
        $("html,body").stop().animate({scrollTop: $(this.hash).offset().top}, 1e3), e.preventDefault()
    }), $(window).on("load scroll", function (e) {
        $(".autoscroll").toggleClass("autoscroll--hidden", 600 < $(this).scrollTop())
    }), e(), $(window).on("resize", function () {
        setTimeout(e, 300)
    }), $(".filter__block").click(function () {
        setTimeout(e, 300)
    }), $(window).scroll(function () {
        $(document).width() < 1e3 && (300 < $(window).scrollTop() ? $(".filter__mob-title").addClass("filter__mob-title--fixed") : $(".filter__mob-title").removeClass("filter__mob-title--fixed"))
    }), $(".grid").masonry({itemSelector: ".grid__item", gutter: 15}), $(".popup-gallery").magnificPopup({delegate: "a", type: "image", tLoading: "Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ° Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ...", mainClass: "mfp-img-mobile", gallery: {enabled: !0, navigateByImgClick: !0, tCounter: "", preload: [0, 1]}, image: {tError: "ÐžÑˆÐ¸Ð±ÐºÐ° Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ"}});
    new Swiper(".branch__slider", {loop: !0, centeredSlides: !0, navigation: {prevEl: ".branch__control--prev", nextEl: ".branch__control--next"}});
    if ($(function () {
        $(".rating-visible").barrating({theme: "css-stars", readonly: !0})
    }), $(function () {
        $(".rating-input").barrating({theme: "css-stars", initialRating: 5})
    }), 1 < $("div.gallery-top .swiper-slide").length) {
        var t = new Swiper(".gallery-top", {spaceBetween: 10, loop: !0, centeredSlides: !0, loopedSlides: 3, navigation: {nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev"}, thumbs: {swiper: n}}), n = new Swiper(".gallery-thumbs", {spaceBetween: 10, slidesPerView: 3, loop: !0, centeredSlides: !0, loopedSlides: 3, watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !0});
        (t.controller.control = n).controller.control = t
    } else $("div.gallery-thumbs").hide(), $("div.swiper-button-next").hide(), $("div.swiper-button-prev").hide();
    if ($(".tabs__link ").click(function () {
        $(".tabs__link").removeClass("tabs__link--active"), $(this).addClass("tabs__link--active");
        var e = $(this).index();
        console.log(e), $(".tabs__block").css({display: "none"}), $(".tabs__block").eq(e).css({display: "flex"})
    ...
    }), 5 < $("div.tabs__slider-wrapper  .swiper-slide").length) t = new Swiper(".tabs__slider", {spaceBetween: 10, slidesPerView: "auto", centeredMode: !0, loop: !0, centeredSlides: !0, loopedSlides: 5, navigation: {nextEl: ".tabs__slider-btn--next", prevEl: ".tabs__slider-btn--prev"}}); else $(".tabs__slider").addClass("tabs__slider--static");
    $(".tabs__slider-wrapper").magnificPopup({delegate: "a", type: "image", mainClass: "mfp-img-mobile", closeOnContentClick: !0, gallery: {enabled: !0, navigateByImgClick: !0, tCounter: "", preload: [0, 1]}}), $(".gallery-top-popups").magnificPopup({delegate: "a", type: "image", mainClass: "mfp-img-mobile", closeOnContentClick: !0, gallery: {enabled: !0, navigateByImgClick: !0, tCounter: "", preload: [0, 1]}}), $(".cart__btn--minus").click(function (e) {
    ...
    }), $("#mob-menu").mmenu({navbar: {title: "<span class='logo navline__logo'>ÐšÐ•Ð ÐÐ¡Ð¤Ð•Ð Ð</span>"}, extensions: {all: ["theme-white", "pagedim-black", "border-none", "fx-menu-slide"], "(min-height: 600px)": ["listview-large"], "(min-height: 900px)": ["listview-huge"]}}, {offCanvas: {pageSelector: "#page"}}), $(".accent__close--top").click(function () {
        $.cookie("popup-top", "1", {expires: 1}), $(this).parent().parent().hide()
    }), $(".accent__close--bottom").click(function () {
        $(this).parent().parent().hide()
    }), null == $.cookie("popup-top") ? $(".accent--top").show() : $(".accent--top").hide(), "shown" != localStorage.getItem("popState") && ($(".accent--bottom").show(), localStorage.setItem("popState", "shown")), $(function () {
        $("body").on("submit", ".call__content", function (e) {
            e.preventDefault();
            var t = $(e.target);
            if (!t.find(".call__about").length) {
                var n = t.find('input[name="Prop[1]"]').val(), i = t.find('input[name="Prop[2]"]').val();
                if ("" == n && "" == i) return void alert("ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð·Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ Ð¸ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½");
                if ("" == n) return void alert("ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð·Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ð¸Ð¼Ñ");
                if ("" == i) return void alert("ÐŸÐ¾Ð¶Ð°Ð»ÑƒÐ¹ÑÑ‚Ð° Ð·Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚Ðµ Ñ‚ÐµÐ»ÐµÑ„Ð¾Ð½")
            }
            if (t.hasClass("sending")) t.find(".call__about").length && (window.location = "/personal/cart/"); else if (t.addClass("sending"), $.post(t.find(".call__about").length ? "/aktsii/add2basket.php" : "/ajax/under_order.php", t.serialize()), t.find(".call__about").length) {
                var a = $("a.header__link.link.link--dark span").text();
                a = Number(a.replace(/[^0-9]/gi, "")), a++, $("a.header__link.link.link--dark span").text("Ð’ ÐºÐ¾Ñ€Ð·Ð¸Ð½Ðµ " + a + " " + declOfNum(a, ["Ñ‚Ð¾Ð²Ð°Ñ€", "Ñ‚Ð¾Ð²Ð°Ñ€Ð°", "Ñ‚Ð¾Ð²Ð°Ñ€Ð¾Ð²"])), t.find(".call__control-btn").val("ÐŸÐµÑ€ÐµÐ¹Ñ‚Ð¸ Ð² ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ")
            } else t.html("<p>ÐœÑ‹ Ð¿Ñ€Ð¾Ð¸Ð½Ñ„Ð¾Ñ€Ð¼Ð¸Ñ€ÑƒÐµÐ¼ Ð²Ð°Ñ Ð¾ Ð¿Ð¾ÑÑ‚ÑƒÐ¿Ð»ÐµÐ½Ð¸Ð¸. Ð¡Ð¿Ð°ÑÐ¸Ð±Ð¾ Ð·Ð° Ð¾Ð±Ñ€Ð°Ñ‰ÐµÐ½Ð¸Ðµ</p>")
        }), $(".style__buy.fast-buy").on("click", function (e) {
            e.preventDefault();
            var t = $(this);
            if (t.hasClass("style__buy--added")) window.location = "/personal/cart/"; else {
                t.css("position", "relative"), t.addClass("style__buy--added"), setTimeout(function () {
                    t.removeClass("style__buy--added"), t.text("ÐšÑƒÐ¿Ð¸Ñ‚ÑŒ")
                }, 5e3);
                var n = $(t.attr("href")).find("form");
                n.find(".call__counter input").val($(this).parents(".style__info-column").find(">.call__counter input").val()), n.trigger("submit"), t.text("Ð’ ÐºÐ¾Ñ€Ð·Ð¸Ð½Ñƒ")
            }
        })
    })
});